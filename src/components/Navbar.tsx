    ...
    <nav className="sticky top-0 z-50 w-full bg-[url('/topbg.jpg')] bg-cover bg-center bg-no-repeat shadow-sm text-white shrink-0">
      <div className="relative mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex items-center" ref={dropdownRef}>
          ...
          {/* Dropdown Menu */}
          {isOpen && (
            <div className="absolute right-0 top-12 mt-2 w-64 origin-top-right rounded-xl border border-gray-700 bg-[#222222] p-2 text-white shadow-2xl ring-1 ring-black/50 z-50">
              <div className="flex flex-col gap-1 text-sm font-medium">
                {/* 🔹 User Profile Preview when Logged In */}
                {isLoggedIn && user && (
                  <div className="px-3 py-2 border-b border-gray-700/60 mb-1">
                    <p className="text-xs font-bold text-[#ffc000] truncate">
                      {user.name || "User"}
                    </p>
                ...
                {isLoggedIn ? (
                  <>
                    <Link
                      href="/my-dream-index-report"
                      onClick={() => setIsOpen(false)}
                      className="flex items-center gap-2.5 rounded-lg px-3 py-2 transition hover:bg-[#ffc000] hover:text-black"
                    >
                      My Dream Index Report
                    </Link>
                    <Link
                      href="/my-favourites"
                      onClick={() => setIsOpen(false)}
                    ...
                    <button
                      ...
                      className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-red-400 transition hover:bg-red-500 hover:text-white"
                    >
                      Logout
                    </button>
                  </>
