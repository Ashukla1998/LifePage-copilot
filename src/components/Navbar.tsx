...
export default function Navbar({ careerCount }: NavbarProps) {
  const formattedCount = careerCount ? Number(careerCount).toLocaleString() : "0";

  return (
    <nav className="sticky top-0 z-50 w-full bg-[url('/topbg.jpg')] bg-cover bg-center bg-no-repeat shadow-sm text-white">
