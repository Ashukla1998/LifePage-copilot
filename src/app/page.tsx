...
export default function Home() {
  ...
  return (
    <div className="h-screen h-dvh w-full overflow-hidden bg-gray-50 flex flex-col">
      {/* Sticky Top Navbar */}
      <Navbar careerCount={count} />

      {/* Main Content Area: Controlled uniform spacing via gap */}
      <main className="flex-1 w-full max-w-5xl mx-auto flex flex-col items-center justify-center gap-8 sm:gap-10 px-4 py-6 min-h-0 overflow-y-auto">
        {/* Form Box */}
        <HomeFormBox
          ref={inputRef}
          careerInput={careerInput}
