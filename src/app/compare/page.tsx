...
//           <div className="flex justify-center items-center group/parent max-[1024px]:gap-5 max-[768px]:flex-col max-[768px]:px-[10px]">
            
//             {/* SEARCH TARGET CAREER (LEFT CARD) */}
//             <div 
//               className="flex-1 max-w-[450px] w-full cursor-pointer"
//               onClick={selectLeft}
//             >
...
//             {/* VS CONTAINER */}
//             <div className="flex items-center justify-center shrink-0 px-2 my-2 sm:my-0">
...
function CompareCareersContent() {
  ...
  // 🔹 PROGRESS HUD COMPONENT (Maintains fixed reserved height)
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 flex flex-col">
      ...
      {/* Main Content Area */}
      <main className="flex-1 w-full flex items-center justify-center p-[10px] sm:p-5 md:p-8 box-border">
        <div className="flex flex-col items-center gap-7 max-w-[1170px] w-full my-0 mx-auto">
          {/* Yellow Comparison Container */}
          <div className="w-full p-5 text-center bg-[#ffc000] border-2 border-black rounded-lg box-border">
            <h2 className="text-2xl font-bold text-gray-900 max-[768px]:text-[18px] mb-[20px]">
              Which Career do you prefer?
            </h2>

            {/* Aligned with items-start so bottom progress bars don't cause card vertical offsets */}
            <div className="flex justify-center items-start group/parent max-[1024px]:gap-5 max-[768px]:flex-col max-[768px]:items-center max-[768px]:px-[10px]">
              {/* SEARCH TARGET CAREER (LEFT CARD) */}
              <div
                className="flex-1 max-w-[450px] w-full flex flex-col cursor-pointer"
                onClick={selectLeft}
              >
                {renderCardContent(leftCareer, selectedSide === 'left')}
                <RenderLearnMore
              ...
              {/* VS ICON CONTAINER */}
              <div className="flex items-center justify-center shrink-0 px-2 my-2 sm:my-0 self-center sm:self-auto sm:pt-28">
                <img src="/vs.png" alt="VS" className="w-[60px] sm:w-[80px] h-auto" />
              </div>
